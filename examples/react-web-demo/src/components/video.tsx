...
export function VideoAndChat({ mediaStream, onSendChat, chatMessages }: VideoAndChatProps) {
    ...
    return (
        <Stack direction="row" gap={2} sx={{ height: '200px', justifyContent: "space-between" }}>
            <video ref={videoRef} controls={false} autoPlay style={{ backgroundColor: "black", width: '300px', height: '100%' }} />
