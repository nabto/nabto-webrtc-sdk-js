...
public class UniversalLinkSupportModule: Module {
  ...
  public func definition() -> ModuleDefinition {
    ...
    OnStartObserving {
        Notifier.registerObserver() { path in
            self.sendEvent("onUniversalLink", ["data": path])
      }
    }

    OnStopObserving {
      Notifier.unregisterObserver()
    }
      
    Function("getInitialUniversalLink") {
        return Notifier.currentData
    }
