...
export const postTestIceServers = <ThrowOnError extends boolean = false>(options: Options<PostTestIceServersData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostTestIceServersResponses, PostTestIceServersErrors, ThrowOnError>({
...
export const deleteTestIceServersByTestId = <ThrowOnError extends boolean = false>(options: Options<DeleteTestIceServersByTestIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteTestIceServersByTestIdResponses, unknown, ThrowOnError>({
